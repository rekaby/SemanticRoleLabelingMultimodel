...
public class FeatureVectorOld {
	...
	public FeatureVectorOld() { grow(); };
	
	public FeatureVectorOld(int _nRows) {		
		nRows = _nRows;
		initCapacity(40);
	}
	
	public FeatureVectorOld(int _nRows, int _nCols) {
		nRows = _nRows;
		initCapacity(40);
	}
	
	public FeatureVectorOld(int _nRows, int _nCols, int _capacity) {
		nRows = _nRows;
	...
	public void addEntries(FeatureVectorOld m) {
		addEntries(m, 1.0);
	}
	
	public void addEntries(FeatureVectorOld m, double coeff) {
	...
	public void addEntriesOffset(FeatureVectorOld m, int offset) {
		addEntriesOffset(m, offset, 1.0);
	}
	
	public void addEntriesOffset(FeatureVectorOld m, int offset, double coeff) {
    ...
    public double dotProduct(FeatureVectorOld _y) {
	...
	public static double dotProduct(FeatureVectorOld _x, FeatureVectorOld _y) {
	...
	public static double dotProduct(FeatureVectorOld _x, double[] _y) {
	...
	public static double dotProduct(FeatureVectorOld _x, double[] _y, int offset) {
