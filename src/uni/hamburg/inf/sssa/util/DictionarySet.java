...
public class DictionarySet implements Serializable {
  ...
  //  private static final String token_mid = "#TOKEN_MID#";
    ...
    private static DictionarySet instance = null;
	public static DictionarySet getInstance() {
	      if(instance == null) {
	         instance = new DictionarySet();
	      }
	      return instance;
	   }
	...
	{	
		...
		for (int i = 0; i < tot; ++i) {
            ...
            if (i == DictionaryTypes.LEMMA.ordinal())
                initDict(DictionaryTypes.LEMMA, dicts[i]);
		}
	}
    ...
    private void initDict(DictionaryTypes tag, Dictionary dict)
    {
        ...
        if (tag == DictionaryTypes.POS || tag == DictionaryTypes.WORD|| tag == DictionaryTypes.LEMMA) {
