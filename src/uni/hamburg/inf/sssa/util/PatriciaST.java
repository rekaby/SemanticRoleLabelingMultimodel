...
public class PatriciaST<Value> {
    ...
    public static void main(String[] args) {
    	 PatriciaST<Float> st = new PatriciaST<Float>();
    	 st.put("Amr", 0.5f);
    	 st.put("Amr", 0.7f);
    	 System.out.println(st.get("Amr"));
    	 System.out.println(st.get("Am"));
    	 System.out.println(st.get("Amr2"));
    	 System.out.println(st.contains("f"));
    	 System.out.println(st.contains("Amr"));
    }
    /*public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("Creating dataset (%d items)...\n", limitItem);
            ...
            System.out.println("Adding (%d items)...\n", limitItem);
            for (int i = 0; i < limitItem; i++)
                st.put(a[v[i]], v[i]);
            ...
            System.out.println("%d items iterated\n", countKeys);
            ...
            System.out.println("Deleting (%d items)...\n", limitDelete);
            ...
            countPass++;
            if (ok) System.out.println("PASS %d TESTS SUCCEEDED\n"+ countPass);
            else    System.out.println("PASS %d TESTS FAILED\n"+    countPass);
