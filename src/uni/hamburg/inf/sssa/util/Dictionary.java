...
public class Dictionary implements Serializable
{
    ...
    //This method is getting a key for a value but thats because we know that Dictionary here has always a unique value per key
    public String writeFirstkeyForAvalue(int value)
    {
